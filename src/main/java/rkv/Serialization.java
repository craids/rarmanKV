...
import static rkv.SerializationHeader.*;
...
public class Serialization extends SerialClassInfo implements Serializer {
			...
			if (packableLongs) {
				...
				for (Object o : b) {
					if (o != null && (o.getClass() != Long.class
							|| (((Long) o).longValue() < 0 && ((Long) o).longValue() != Long.MAX_VALUE))) {
						packableLongs = false;
						break;
					}
				}
	...
	private void serializeCollection(int header, DataOutput out, Object obj, FastArrayList objectStack)
			throws IOException {
	...
	private Object[] deserializeArrayObject(DataInput is, FastArrayList objectStack)
	...
	private ArrayList<Object> deserializeArrayList(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private java.util.LinkedList deserializeLinkedList(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private Vector<Object> deserializeVector(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private HashSet<Object> deserializeHashSet(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private LinkedHashSet<Object> deserializeLinkedHashSet(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private TreeSet<Object> deserializeTreeSet(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private TreeMap<Object, Object> deserializeTreeMap(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private HashMap<Object, Object> deserializeHashMap(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private IdentityHashMap<Object, Object> deserializeIdentityHashMap(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private LinkedHashMap<Object, Object> deserializeLinkedHashMap(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private Hashtable<Object, Object> deserializeHashtable(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
	...
	private Properties deserializeProperties(DataInput is, FastArrayList objectStack)
			throws IOException, ClassNotFoundException {
		int size = LongPacker.unpackInt(is);
