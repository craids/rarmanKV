...
import rkv.indexer.BasicIndexQuery;
import rkv.indexer.IndexQuery;
import rkv.utils.codec.VariableByteCodec;
import rkv.utils.collections.longs.LongHash.BucketEntry;
import rkv.utils.collections.longs.LongHash.Cleaner;
import rkv.utils.collections.longs.PurgeOptObservableLongLRUMap;
import rkv.utils.io.FastMultiByteArrayOutputStream;
import rkv.utils.lang.ArrayUtils;
import rkv.utils.lang.Primitives;
...
public class BTree extends Paged {
    ...
    private final BTreeNode createBTreeNode(BTreeRootInfo root, byte status,
             BTreeNode parent) throws BTreeException {
        if (parent == null) {
            throw new IllegalArgumentException();
        }
        Page p = getFreePage();
