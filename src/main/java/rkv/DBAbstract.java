...
abstract class DBAbstract implements DB {
	...
	abstract <A> void update(long recid, A obj, Serializer<A> serializer) throws IOException;
	...
	public synchronized <K, V> ConcurrentMap<K, V> createHashMap(String name, Serializer<K> keySerializer,
	...
	public synchronized <K, V> ConcurrentNavigableMap<K, V> createTreeMap(String name, Comparator<K> keyComparator,
	...
	public synchronized <K> NavigableSet<K> createTreeSet(String name, Comparator<K> keyComparator,
