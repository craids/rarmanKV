...
public class RKVDBStats {
	...
	public RKVDBStats(long statsResetTime, long size, int numberOfFilesPendingCompaction,
			...
			long numberOfTombstonesCleanedUpDuringOpen, long numberOfRecordsCopied, long numberOfRecordsReplaced,
			long numberOfRecordsScanned, long sizeOfRecordsCopied, long sizeOfFilesDeleted, long sizeReclaimed,
			long compactionRateSinceBeginning, RKVDBOptions options) {
	...
	public RKVDBOptions getOptions() {
		return options;
	}
	...
	public String toString() {
		return MoreObjects.toStringHelper("").add("statsResetTime", statsResetTime).add("size", size)
				.add("Options", options).add("CompactionJobRateInInterval", getUnit(compactionRateInInternal))
				...
				.add("numberOfRecordsScanned", numberOfRecordsScanned).add("sizeOfRecordsCopied", sizeOfRecordsCopied)
				.add("sizeOfFilesDeleted", sizeOfFilesDeleted).add("sizeReclaimed", sizeReclaimed)
				.add("rehashCount", rehashCount).add("maxSizePerSegment", maxSizePerSegment)
				...
				.add("segmentStats", Arrays.toString(segmentStats)).add("numberOfSegments", numberOfSegments)
				.add("staleDataPercentPerFile", staleDataMapToString()).toString();
	}
