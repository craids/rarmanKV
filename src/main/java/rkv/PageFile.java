...
final class PageFile {
	...
	PageFile(String fileName, boolean readonly, boolean transactionsDisabled, Cipher cipherIn, Cipher cipherOut,
			boolean useRandomAccessFile, boolean lockingDisabled) throws IOException {
