...
class SegmentStats {
	...
	public String toString() {
		MoreObjects.ToStringHelper helper = MoreObjects.toStringHelper("").add("noOfEntries", this.noOfEntries);
	...
	public boolean equals(Object obj) {
		...
		return that.noOfEntries == noOfEntries && that.numberOfChunks == numberOfChunks
				&& that.numberOfSlots == numberOfSlots && that.freeListSize == freeListSize;
	}
